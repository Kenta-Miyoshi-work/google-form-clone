...
- typeはshortText, paragraph, email, number, date, time, radio, checkbox, select, rating, matrix, file, consentのいずれか
- 選択式ではallowOther, randomizeOptionsを書ける
- ratingではscaleMin, scaleMax, scaleMinLabel, scaleMaxLabelを書ける
- matrixではrowsとcolumnsを書ける
- fileではfileTypesとmaxFilesを書ける
- consentではconsentTextを書ける
